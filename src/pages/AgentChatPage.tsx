...
const AgentChatPage: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    const assistantMsg: Message = {
      ...
      conversation_id: 'mock',
      role: 'assistant',
      content: `Esta é uma demonstração da interface do ${agent?.name}. A integração com o motor de IA será ativada em breve. Sua pergunta foi recebida com sucesso e o sistema está preparado para processá-la quando conectado ao agente especialista.`,
      created_at: new Date().toISOString(),
    }
  ...
  if (!canAccessAgent(agent.slug)) {
    return (
      <div className="flex items-center justify-center h-full px-6" style={{ fontFamily: 'Montserrat, sans-serif' }}>
        <div
          className="max-w-sm w-full text-center p-10 rounded-2xl"
          style={{ backgroundColor: '#ffffff', border: '1px solid rgba(0,0,0,0.07)', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}
        >
          <div
          ...
          <h2 className="text-lg font-semibold mb-2" style={{ color: '#1a1a1a', letterSpacing: '-0.015em' }}>
            Agente bloqueado
          </h2>
          <p className="text-sm font-light leading-relaxed mb-6" style={{ color: '#9ca3af' }}>
            <span className="font-medium" style={{ color: '#1a1a1a' }}>{agent.name}</span> está disponível
            no plano Pro. Faça upgrade para acessar todos os agentes especialistas.
          </p>
          <button
            onClick={() => navigate('/plans')}
            className="w-full py-2.5 rounded-xl text-sm font-medium transition-all duration-200 mb-3"
          ...
          <button
            onClick={() => navigate('/agents')}
            className="w-full py-2 text-sm font-light transition-colors duration-150"
            style={{ color: '#9ca3af' }}
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <h1
              className="font-semibold text-base leading-none mb-1 truncate"
              style={{ color: '#1a1a1a', letterSpacing: '-0.01em' }}
            >
              {agent.name}
            </h1>
            <p className="text-xs font-light truncate" style={{ color: '#9ca3af' }}>
              {agent.specialty}
            </p>
          </div>
            ...
            <div className="flex flex-col items-center justify-center h-full max-w-lg mx-auto text-center">
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 4px 16px rgba(212,168,67,0.12)',
                }}
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full">
                {agent.suggestions.map((suggestion) => (
                  <button
                    ...
                    className="flex items-center gap-2 text-left px-4 py-3 rounded-xl text-sm font-light transition-all duration-150 group"
                    style={{
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.backgroundColor = '#fdfaf3'
                    }}
                    onMouseLeave={e => {
          ...
          <div className="max-w-3xl mx-auto">
            <div
              ...
              onFocusCapture={e => {
                ...
                parent.style.borderColor = '#d4a843'
                parent.style.boxShadow = '0 0 0 3px rgba(212,168,67,0.08)'
              }}
              onBlurCapture={e => {
                const parent = e.currentTarget
                parent.style.borderColor = 'rgba(0,0,0,0.08)'
          ...
          <div className="space-y-2">
            {agent.suggestions.map((s) => (
              <button
                ...
                onMouseEnter={e => {
                  e.currentTarget.style.backgroundColor = '#fdfaf3'
                  e.currentTarget.style.borderColor = '#f3e4b8'
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.backgroundColor = '#f9fafb'
        ...
        <div className="p-6">
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs font-semibold" style={{ color: '#7a5c18' }}>Em breve</p>
            </div>
            <p className="text-xs font-light leading-relaxed" style={{ color: '#92650a', opacity: 0.75 }}>
              Histórico de casos, anotações clínicas e exportação de condutas.
            </p>
          </div>
        </div>
      </div>
