...
import { Bone, Brain, HeartHandshake, Activity, Home, ArrowRight } from 'lucide-react'
...
const AgentCard: React.FC<AgentCardProps> = ({ agent }) => {
  ...
  return (
    <div
      className="group relative bg-white rounded-2xl p-6 cursor-pointer overflow-hidden transition-all duration-300"
      style={{
    ...
    >
      ...
      >
        <Icon size={20} style={{ color: '#b8902a' }} />
      </div>
      ...
      <div className="mb-5">
        ...
        <p
          ...
          style={{ color: '#d4a843', letterSpacing: '0.08em' }}
        >
          {agent.specialty}
        </p>
      ...
      <div className="flex items-center justify-between">
        ...
        <div
          ...
          style={{ backgroundColor: '#d4a843', opacity: 0.4 }}
        />
      </div>
    </div>
  )
